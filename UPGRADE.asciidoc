...
We merged the WIRED_MAC_AUTH and Ethernet-NoEAP to Ethernet-NoEAP so the configuration needs to be updated, to do that run:
 ...
 sed -i "s/WIRED_MAC_AUTH/Ethernet-NoEAP/g" conf/vlan_filters.conf
 sed -i "s/WIRED_MAC_AUTH/Ethernet-NoEAP/g" conf/radius_filters.conf
 sed -i "s/WIRED_MAC_AUTH/Ethernet-NoEAP/g" conf/switch_filters.conf
 sed -i "s/WIRED_MAC_AUTH/Ethernet-NoEAP/g" conf/authentication.conf
